...
def create_JSON_to_insert(total_csv: int):
    ...
    for i in range(total_csv):
        name_file = 'src/natureza/natureza.csv' #para teste (mudar para o nome real)
...
JSON_TO_INSERT_NATUREZA = create_JSON_to_insert(total_planilhas)
